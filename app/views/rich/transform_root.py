...
def render_transform_root_rich(state: AppState, console: Console, error: str | None = None) -> None:
    ...
    menu.add_row("[bold magenta]8)[/]", "Descriptive statistics")
    menu.add_row("[bold magenta]9)[/]", "Grouped average summary")
    menu.add_row("[bold magenta]10)[/]", "Top N rows by numeric column")
    menu.add_row("[bold magenta]11)[/]", "String-list value ranking")
